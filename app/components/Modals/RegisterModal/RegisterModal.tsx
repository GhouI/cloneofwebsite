...
const RegisterModal = () => {
    ...
    const FooterContent = (
        <div className="flex flex-col gap-4 mt-3">
            <hr />
            <ButtonComponent outline={true} text='Continue with Google' icon={FcGoogle} onClick={() => { }} />
            <ButtonComponent outline={true} text='Contine with Facebook' icon={AiFillFacebook} onClick={() => { }} />
            <ButtonComponent outline={true} text='Contine with Apple' icon={AiFillApple} onClick={() => { }} />
